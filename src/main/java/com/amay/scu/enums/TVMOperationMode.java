...
public enum TVMOperationMode implements OperationMode, TOMServiceProperties {
    IN_SERVICE(true, true, "-fx-background-color: #00FF00"),  // Green 100,110,111
    OUT_OF_SERVICE("-fx-background-color: #FFA500"),         // Orange 300
    ...
    TVMOperationMode(boolean qrSaleModeEnabled, boolean cardProcessingModeEnabled, String color) {
