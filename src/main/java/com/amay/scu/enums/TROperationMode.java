...
public enum TROperationMode implements OperationMode, TOMServiceProperties {
    ...
    TROperationMode(boolean qrSaleModeEnabled, boolean cardProcessingModeEnabled, String color) {
