...
@Data
@NoArgsConstructor
public class LiveEFO extends LiveTOM {
    public LiveEFO(String equipId, String efoIp, String stationId, String equipName, String deviceType){
        super(equipId, efoIp, stationId, equipName, deviceType);
    }
...
//    }
    ...
    public void setEFO_software(String efo_software) {
        String oldEFO_software = this.efo_software;
        this.efo_software = efo_software;
        parameterVersionListener.firePropertyChange("efo_software", oldEFO_software, efo_software);
    }
