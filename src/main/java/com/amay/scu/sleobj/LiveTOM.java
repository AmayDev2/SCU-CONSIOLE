...
public class LiveTOM implements LiveSLE {
   ...
   final Logger logger = LoggerFactory.getLogger(getClass());
    ...
    public LiveTOM(String equipId,String tomIp,String stationId){
...
//    }
    ...
    public void setFare_table(String fare_table) {
        ...
        pcs.firePropertyChange("fare_table", oldFare_table, fare_table);
    }
    ...
    public void setTom_software(String tom_software) {
        ...
        pcs.firePropertyChange("tom_software", oldTom_software, tom_software);
    }

    public void setBlacklist(String blacklist) {
        String oldBlacklist = this.blacklist;
        this.blacklist = blacklist;
        pcs.firePropertyChange("blacklist", oldBlacklist, blacklist);
    }

    public void setCalendar(String calendar) {
        String oldCalendar = this.calendar;
        this.calendar = calendar;
        pcs.firePropertyChange("calendar", oldCalendar, calendar);
    }

    public void setQr_key(String qr_key) {
        String oldQr_key = this.qr_key;
        this.qr_key = qr_key;
        pcs.firePropertyChange("qr_key", oldQr_key, qr_key);
    }

    public void setTicket(String ticket) {
        String oldTicket = this.ticket;
        this.ticket = ticket;
        pcs.firePropertyChange("ticket", oldTicket, ticket);
    }
