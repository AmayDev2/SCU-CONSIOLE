...
private static final long serialVersionUID = 0L;
  ...
  public static final int TOM_SOFTWARE_FIELD_NUMBER = 3;
  private volatile java.lang.Object tomSoftware_;
  /**
   * <code>string tom_software = 3;</code>
   * @return The tomSoftware.
   */
  public java.lang.String getTomSoftware() {
    java.lang.Object ref = tomSoftware_;
    if (ref instanceof java.lang.String) {
      return (java.lang.String) ref;
    } else {
      com.google.protobuf.ByteString bs = 
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (!getTomSoftwareBytes().isEmpty()) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 3, tomSoftware_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!getTomSoftwareBytes().isEmpty()) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(3, tomSoftware_);
    }
    if (!getBlacklistBytes().isEmpty()) {
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + TOM_SOFTWARE_FIELD_NUMBER;
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(org.network.monitorandcontrol.tom.TOMVersionCheck other) {
      ...
      if (!other.getTomSoftware().isEmpty()) {
        tomSoftware_ = other.tomSoftware_;
        onChanged();
      }
  ...
  checkByteStringIsUtf8(value);
    ...
    private java.lang.Object tomSoftware_ = "";
    /**
     * <code>string tom_software = 3;</code>
     * @return The tomSoftware.
     */
    ...
    /**
     * <code>string tom_software = 3;</code>
     * @param value The tomSoftware to set.
     * @return This builder for chaining.
     */
    public Builder setTomSoftware(
        java.lang.String value) {
      if (value == null) {
    throw new NullPointerException();
  }
     ...
     * @return This builder for chaining.
     */
    public Builder clearTomSoftware() {
      
      tomSoftware_ = getDefaultInstance().getTomSoftware();
      onChanged();
      return this;
    }
    /**
     * <code>string tom_software = 3;</code>
     * @param value The bytes for tomSoftware to set.
     * @return This builder for chaining.
     */
    public Builder setTomSoftwareBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) {
    throw new NullPointerException();
  }
